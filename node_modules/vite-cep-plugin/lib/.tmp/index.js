...
var debugAll = [{
  mainPath: "./template-react/index.html",
  // DEBUG the React Template
  name: "template-react",
  ...
  mainPath: "./template-vue/index.html",
  // DEBUG the Vue Template
  name: "template-vue",
  ...
  mainPath: "./template-svelte/index.html",
  // DEBUG the Svelte Template
...
function _arrayWithoutHoles(arr) { if (__isArray(arr)) return _arrayLikeToArray(arr); }
...
var config = {
  ...
  panels: [{
    ...
    width: 600,
    height: 650
  }].concat(_toConsumableArray(debugAll)),
  build: {
    jsxBin: "copy",
    sourceMap: true
  },
